...
ionice -c 2 -n 7 wget --limit-rate=800k -O /home/adivp416/public_html/covid19/toronto_cases.csv https://ckan0.cf.opendata.inter.prod-toronto.ca/datastore/dump/e5bf35bc-e681-43da-b2ce-0242d00922ad
ionice -c 2 -n 7 wget --limit-rate=800k -O /home/adivp416/public_html/covid19/ontario_cases.csv https://data.ontario.ca/dataset/1115d5fe-dd84-4c69-b5ed-05bf0c0a0ff9/resource/d1bfe1ad-6575-4352-8302-09ca81f7ddfc/download/cases_by_status_and_phu.csv

cd $cdir

cd /home/adivp416/public_html/covid19/
ionice -c 3 rm tmp*.hdf5
